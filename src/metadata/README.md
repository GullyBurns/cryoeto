 ...
 * [cryoeto.yml](cryoeto.yml)
     * Determines how your purl.obolibrary.org/obo/cryoeto/ redirects will be handled
     ...
     * Paste in the contents of [cryoeto.yml](cryoeto.yml)
 ...
 * [cryoeto.md](cryoeto.md)
     ...
     * Paste in the contents of [cryoeto.md](cryoeto.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
